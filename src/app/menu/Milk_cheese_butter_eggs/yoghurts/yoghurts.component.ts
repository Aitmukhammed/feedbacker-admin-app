...
import data from '../../../../assets/i18n/menu/Milk_cheese_butter_eggs/yoghurts.json'
...
@Component({
  selector: 'app-yoghurts',
  templateUrl: './yoghurts.component.html',
  styleUrls: ['./yoghurts.component.css']
})
export class YoghurtsComponent {
