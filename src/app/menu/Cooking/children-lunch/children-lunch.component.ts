...
import data from '../../../../assets/i18n/menu/cooking/children_lunch.json'
...
@Component({
  selector: 'app-children-lunch',
  templateUrl: './children-lunch.component.html',
  styleUrls: ['./children-lunch.component.css']
})
export class ChildrenLunchComponent {
