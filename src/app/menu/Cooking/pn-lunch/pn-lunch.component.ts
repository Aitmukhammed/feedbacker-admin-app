...
import data from '../../../../assets/i18n/menu/cooking/pn_lunch.json'
...
@Component({
  selector: 'app-pn-lunch',
  templateUrl: './pn-lunch.component.html',
  styleUrls: ['./pn-lunch.component.css']
})
export class PnLunchComponent {
