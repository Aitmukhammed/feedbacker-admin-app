...
import data from '../../../../assets/i18n/menu/cooking/cakes_pastries.json'
...
@Component({
  selector: 'app-cakes-pastries',
  templateUrl: './cakes-pastries.component.html',
  styleUrls: ['./cakes-pastries.component.css']
})
export class CakesPastriesComponent {
