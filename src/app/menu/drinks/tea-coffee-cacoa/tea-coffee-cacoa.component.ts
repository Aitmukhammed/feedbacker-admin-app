...
import data from '../../../../assets/i18n/menu/drinks/tea coffee cocoa.json'
...
@Component({
  selector: 'app-fruits',
  templateUrl: './tea-coffee-cacoa.component.html',
  styleUrls: ['./tea-coffee-cacoa.component.css']
})
export class TeaCoffeeCacoaComponent {
